...
# Fetch the state outline for North Carolina
nc_outline <- states(cb = TRUE, resolution = "20m") %>%
  filter(NAME == "North Carolina")  # Ensure only North Carolina is selected
...
write("cell size, HexCreation, Join, Summarize", output_file) # write the header
